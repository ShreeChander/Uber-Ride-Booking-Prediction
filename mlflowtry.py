...
def mlflow_run():
    ...
    # df1 = read_data_mysql()
    df1 = pd.read_csv(r"D:\GUVI\Assesments\Uber demand price Prediction\data\justadf.csv")
    ...
    # df = df1
    # df.to_csv(r"D:\GUVI\Assesments\Uber demand price Prediction\data\Cleaned_booking_times.csv", index=False)
